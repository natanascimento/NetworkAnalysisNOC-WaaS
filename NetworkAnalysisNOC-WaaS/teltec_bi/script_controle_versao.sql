...
/*Criação da table de controle de versão para que a mesma possa ser inserida no relatorio do Power BI*/

CREATE TABLE controle_versao (
 id_version integer not null,
 versao varchar not null, 
 data date not null,
 mudancas_realizadas varchar not null
);

/*Inserindo em public.contrle_versao*/
...
/*Foi necessário criar um novo schema (teltec_bi), pois estavamos utilizando o schema public, e por motivos de boas práticas, optamos pela alteração do schema*/
create table teltec_bi.controle_versao as (select * from public.controle_versao)